...
- [Create Main DB] CREATE DATABASE full_stack_dev;
- [Create Test DB] CREATE DATABASE full_stack_test;
- ALTER DATABASE full_stack_dev OWNER TO full_stack_user;
- GRANT ALL PRIVILEGES ON DATABASE full_stack_dev TO full_stack_user;
- ALTER DATABASE full_stack_test OWNER TO test_user;
...
You can Install this project to your PC by downloading it as a ZIP File to your PC and unnzip the file.
